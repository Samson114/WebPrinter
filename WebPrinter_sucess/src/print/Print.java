...
public class Print implements Printable{
	...
	public static String user="hello world!";
	public static String table="table";
	public static String caipin="caipin";
	public static String total="18元";
...
public static String getCaipin() {
	...
	public static void setCaipin(String caipin) {
		Print.caipin = caipin;
	}
...
//	   String str = "功能测试";
	...
	// 设置打印颜色为黑色
	   ...
	   case 0:
	    ...
	    // ) ;
	    g2.drawString("餐桌："+table, (float) x, (float) y + 1 * heigth + img_Height); //第一排
	    g2.drawString("1、"+caipin, (float) 10, (float) 40 + 1 * heigth + img_Height); //第二排
	    g2.drawString("数量合计："+total, (float) 20, (float) 60 + 1 * heigth + img_Height); //
